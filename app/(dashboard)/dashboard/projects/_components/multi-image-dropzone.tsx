        ...
        <div className="grid grid-cols-[repeat(1,1fr)] gap-2">
          ...
          {(!value || value.length < (dropzoneOptions?.maxFiles ?? 0)) && (
            <div
              ...
              // className="flex h-[150px] w-[350px] items-center justify-center border-2 rounded-xl border-dotted border-spacing-3 border-muted-foreground aspect-video hover:border-primary cursor-pointer"
            >
              {/* Main File Input */}
              ...
              <div className="flex flex-col items-center justify-center text-xs text-gray-400">
                ...
                <div className="text-gray-400">
                  Arraste e solte para fazer upload das imagens
                </div>
                <div className="mt-3">
          ...
          {value?.map(({ file, progress }, index) => (
            <div
              key={index}
              className={variants.image + "relative aspect-video"}
            >
              <Image
              ...
              {imageUrls[index] && !disabled && progress === "COMPLETE" && (
                <div
                  ...
                  onClick={async (e) => {
                    e.stopPropagation();
                    // Atualize o estado local removendo a imagem
                    const updatedValue = value.filter((_, i) => i !== index);
                    void onChange?.(updatedValue);
